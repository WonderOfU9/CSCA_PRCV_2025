...
from AuDrA_DataModule import AuDrADataModule_VARS, RaterGeneralizationOneDataloader, RaterGeneralizationTwoDataloader, FarGeneralizationDataloader
from CSCA_pl_plus_imgsums import CSCA_CLIP_LCR_SCT
import os
...
dm = AuDrADataModule_VARS(args = args)
dm.setup()
...
model = CSCA_CLIP_LCR_SCT(args)

tb_logger = pl.loggers.TensorBoardLogger('logs_clip_CSCA_LCR_SCT/')
...
model.cur_filename = "rg1_output_dataframe_clip_CSCA_LCR_SCT.csv"
trainer.test(test_dataloaders=rg1_dataloader,verbose = False)
model.cur_filename = "rg2_output_dataframe_clip_CSCA_LCR_SCT.csv"
trainer.test(test_dataloaders=rg2_dataloader,verbose = False)
model.cur_filename = "fg_output_dataframe_clip_CSCA_LCR_SCT.csv"
