...
from CSCA_pl_plus_imgsums import CSCA_CLIP_LCR
import os
...
model = CSCA_CLIP_LCR(args)

tb_logger = pl.loggers.TensorBoardLogger('logs_clip_CSCA_LCR/')
...
model.cur_filename = "rg1_output_dataframe_clip_CSCA_LCR.csv"
trainer.test(test_dataloaders=rg1_dataloader,verbose = False)
model.cur_filename = "rg2_output_dataframe_clip_CSCA_LCR.csv"
trainer.test(test_dataloaders=rg2_dataloader,verbose = False)
model.cur_filename = "fg_output_dataframe_clip_CSCA_LCR.csv"
