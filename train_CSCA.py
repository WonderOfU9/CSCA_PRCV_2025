...
from CSCA_pl_plus_imgsums import CSCA_CLIP
import os
...
model = CSCA_CLIP(args)

tb_logger = pl.loggers.TensorBoardLogger('logs_clip_CSCA/')
...
model.cur_filename = "rg1_output_dataframe_clip_CSCA.csv"
trainer.test(test_dataloaders=rg1_dataloader,verbose = False)
model.cur_filename = "rg2_output_dataframe_clip_CSCA.csv"
trainer.test(test_dataloaders=rg2_dataloader,verbose = False)
model.cur_filename = "fg_output_dataframe_clip_CSCA.csv"
